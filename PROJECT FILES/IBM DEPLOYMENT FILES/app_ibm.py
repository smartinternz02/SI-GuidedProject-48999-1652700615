...
API_KEY = "rTk7Squdi0QHtM7qcUUJ8__RK4Je2JhG-TOASajKmJHs"
...
def y_predict():
   ...
   # pred = model.predict(x_test)
    ...
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/13ff6e93-dfa0-4b83-8678-c405d95dcf8a/predictions?version=2022-06-07', json=payload_scoring,
